                                        ...
                                        {order.cartItems.map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index} className="text-orange-300">
                                                    ...
                                                    <td className="h-12 px-6 text-md transition duration-300 border-t border-l text-orange-600  first:border-l-0 border-orange-100 stroke-slate-500 text-slate-500 first-letter:uppercase ">
                                                        {order.status}
                                                    </td>
                                                    ...
                                                    <td onClick={()=> orderDelete(order.id)} className="h-12 px-6 text-md transition duration-300 border-t border-l first:border-l-0 border-orange-100 stroke-slate-500 text-slate-500 text-red-500 cursor-pointer ">
                                                        Delete
                                                    </td>
                                                </tr>
                                            )
